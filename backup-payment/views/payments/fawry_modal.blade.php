...
<div class="modal-body px-4 pt-2">
    <div class="text-center mb-4">
        <h4 class="modal-title fw-bold">Fawry Payment</h4>
    ...
    <div class="payment-instructions card shadow-sm mb-4">
        ...
        <div class="card-body">
            <ol class="mb-0 ps-3">
                <li class="mb-2">Visit any Fawry outlet or use the myFawry app</li>
                <li class="mb-2">Ask to pay for a service using your reference code</li>
                <li class="mb-2">Enter the merchant code: <strong>{{ config('payment.fawry.merchant_code') ?: 'MEDCAPS' }}</strong></li>
                <li class="mb-2">Enter the amount: <strong>{{ $course->price }} EGP</strong></li>
                <li class="mb-2">Provide the payment code shown above</li>
...
<script>
    ...
    function initFawryPolling(paymentId) {
        console.log('Fawry payment polling initialized for payment ID:', paymentId);
        ...
        const statusInterval = setInterval(() => {
            ...
            .then(data => {
                ...
                if (data.status === 'completed') {
                    ...
                    const statusMessage = document.getElementById('status-message');
                    if (statusMessage) {
                        statusMessage.innerHTML = 'Payment expired. Please try again with a new payment code.';
                    }
                }
            })
            .catch(error => {
        ...
        window.fawryStatusInterval = statusInterval;
    }
    
    // Make the function globally available
    window.initFawryPolling = initFawryPolling;
    
    // Initialize the polling when the modal is shown
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Fawry modal loaded, initializing polling');
